...
const SHELL=['./','./index.html','./validation.html',`./style.css${ASSET_QUERY}`,`./enhancements.css${ASSET_QUERY}`,`./validation.css${ASSET_QUERY}`,`./scoring-core.js${ASSET_QUERY}`,`./pwa-ui.js${ASSET_QUERY}`,`./game.js${ASSET_QUERY}`,`./validation.js${ASSET_QUERY}`,`./manifest.webmanifest${ASSET_QUERY}`,CONFIG_PATH,'./research/validation-set.json','./assets/icon-192.png','./assets/icon-512.png'];
